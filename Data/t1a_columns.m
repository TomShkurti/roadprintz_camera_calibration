...
%Also change the numbers in lines 97 and 99	
% %1
% target_motion_vector_xy = 0.0 : 0.05 : 0.0;
...
%3
target_motion_vector_xy = 0.0 : 0.1 : 0.1;
target_motion_vector_z = 0.3 : 0.02 : 0.4;
...
for d = 0 : 5 : 95
	...
	csvwrite(sprintf('columnarity/distorted_%d_%d.csv', 3, d), data_block_d);
	data_block_u = [sled_decimated targ_decimated projected_decimated];
	csvwrite(sprintf('columnarity/undistorted_%d_%d.csv', 3, d), data_block_u);
end