big_block = csvread('snoise_results/snoise_undistorted.csv');
%big_block = csvread('snoise_results/snoise_distorted.csv');
...
n = reshape(n, 20, 26);
s = reshape(s, 20, 26);
findings_k = reshape(findings_k, 20, 26);
findings_r = reshape(findings_r, 20, 26);
findings_f = reshape(findings_f, 20, 26);
